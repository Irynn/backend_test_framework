...
public class AlbumsSmokeTests extends BaseTest {
    ...
    public void getAllAlbums(){
        ...
        final List<AlbumDTO> albumsList = response.getBody().jsonPath().getList("", AlbumDTO.class);
    ...
    public void getAlbmById(){
        ...
        response.then()
                .statusCode(200);
        AlbumDTO receivedAlbum = response.getBody().jsonPath().getObject("", AlbumDTO.class);
